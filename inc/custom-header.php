 ...
 *
 * @uses agency_underscores_header_style()
 */
function agency_underscores_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'agency_underscores_custom_header_args', array(
		'default-image'          => '',
...
if ( ! function_exists( 'agency_underscores_header_style' ) ) :
	 ...
	 *
	 * @see agency_underscores_custom_header_setup().
	 */
	function agency_underscores_header_style() {
